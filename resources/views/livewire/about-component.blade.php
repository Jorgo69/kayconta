    ...
    <div class="page-header breadcrumb-wrap">
        <div class="container">
            <div class="breadcrumb">
                ...
                <span></span> A propos de {{config('app.name')}}
            </div>
        </div>
    </div>
        ...
        <div class="container pt-25">
            <div class="row">
                <div class="col-lg-6 align-self-center mb-lg-0 mb-4">
                    <h6 class="mt-0 mb-15 text-uppercase font-sm text-brand wow fadeIn animated">La Plateforme</h6>
                    <h1 class="font-heading mb-40">
                        Nous facilitons l'exposition de vos oeuvres exprimez vous librement
                    </h1>
                    <p>Nous avons toujours une pour but que de valorisez l'expression par votre talent votre connaissance votre savoir faire.</p>
                ...
                <div class="col-lg-6">
                    <img src="{{asset('kayconta-app/public/assets/imgs/page/about-1.png')}}" alt="">
                </div>
            </div>
        </div>
    </section>                
        ...
        <div class="container pt-25">
            ...
            <div class="row align-items-center">
                <div class="col-md-6 col-lg-4">
                    <div class="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
                        <div class="hero-card-icon icon-left-2 hover-up ">
                            <img class="btn-shadow-brand hover-up border-radius-5 bg-brand-muted" src="{{asset('kayconta-app/public/assets/imgs/page/avatar-1.jpg')}}" alt="">
                        </div>
                        <div class="pl-30">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
                        <div class="hero-card-icon icon-left-2 hover-up ">
                            <img class="btn-shadow-brand hover-up border-radius-5 bg-brand-muted" src="{{asset('kayconta-app/public/assets/imgs/page/avatar-3.jpg')}}" alt="">
                        </div>
                        <div class="pl-30">
                            <h5 class="mb-5 fw-500">
                                B.Gates
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
                        <div class="hero-card-icon icon-left-2 hover-up ">
                            <img class="btn-shadow-brand hover-up border-radius-5 bg-brand-muted" src="{{asset('kayconta-app/public/assets/imgs/page/avatar-2.jpg')}}" alt="">
                        </div>
                        <div class="pl-30">
                            <h5 class="mb-5 fw-500">
                                B. Meyers
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
                        <div class="hero-card-icon icon-left-2 hover-up ">
                            <img class="btn-shadow-brand hover-up border-radius-5 bg-brand-muted" src="{{asset('kayconta-app/public/assets/imgs/page/avatar-4.jpg')}}" alt="">
                        </div>
                        <div class="pl-30">
                            <h5 class="mb-5 fw-500">
                                J. Bezos
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
                        <div class="hero-card-icon icon-left-2 hover-up ">
                            <img class="btn-shadow-brand hover-up border-radius-5 bg-brand-muted" src="{{asset('kayconta-app/public/assets/imgs/page/avatar-5.jpg')}}" alt="">
                        </div>
                        <div class="pl-30">
                            <h5 class="mb-5 fw-500">
                                B.Gates
