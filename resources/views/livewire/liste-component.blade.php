            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="single-header mb-50">
                        ...
                        <span></span> Une Oeuvre de {{$chapter->user->pseudo}}
                        ...
                        <div class="row">
                                ...
                                <article class="first-post mb-30 wow fadeIn animated hover-up">
                                    <div class="img-hover-slide position-relative overflow-hidden">
                                        ...
                                        <div class="post-thumb img-hover-scale">
                                            <a href="#">
                                                <img src="{{asset('kayconta-app/public/assets/imgs/mangas')}}/{{$chapter->manga->cover_image}}" alt="" width="100%" height="100%">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="entry-content">
                                        <div class="entry-meta meta-1 mb-30">
                                            ...
                                            <div class="font-sm">
                                                <span><span class="mr-10 text-muted"><i class="fi-rs-eye"></i></span>{{ $nbrViews }}</span>
                                                <span class="ml-30"><span class="mr-10 text-muted"><i class="fi-rs-comment-alt"></i></span>{{ $nbrComments }} </span></div>
                                        </div>
                                        ...
                                        <div class="mb-20 entry-meta meta-2">
                                            ...
                                            @if (in_array($chapter->manga->id, $favorites))
                                                <a href="#" type="button" role="button" wire:click.prevent="RemoveFavorite()">
                                                    <i class="fi-rs-bookmark"></i> Retirer des favoris
                                                </a>
                                            @else
                            ...
                            <div class="col-md-12 wow fadeIn animated hover-up mb-30">
                                <a href="{{ route('chapter.streaming', ['chapter_id' => $liste->id])}}">
                                    ...
                                    <div class="col-md-2">
                                        <a type="button" href="{{ route('chapter.streaming', ['chapter_id'=> $liste->id])}}" class="btn btn-sm text-light float-right"  style="width: 100px">Lire</a>
                                    </div>
                                    </div>
                                    <div class="col-auto">
                                        <a href="{{ route('chapter.streaming', ['chapter_id' => $liste->id])}}">
                                            <img src="{{asset('kayconta-app/public/assets/imgs/chapters/covers')}}/{{$liste->chapter_cover}}" alt="{{ substr($liste ->title, 0 ,11)}}" width="100" height="100%">
                                        </a>
                                    </div>
                                </div>
                                </a>
                ...
                <div class="col-lg-3 primary-sidebar sticky-sidebar">
                    <div class="widget-area">
                        ...
                        <!--Widget categories-->
                        <div class="sidebar-widget widget_categories mb-40  d-sm-none">
                            ...
                            <div class="post-block-list post-module-1 post-module-5">
                                <ul>
                                    ...
                                    <li class="cat-item cat-item-2 text-left"><a href="#">{{ $genre ->name}}</a> </li>
                                    @empty
                        ...
                        <div class="sidebar-widget widget_alitheme_lastpost mb-20">
                            <div class="widget-header position-relative mb-20 pb-10">
                                <h5 class="widget-title">{{ __('Du même auteur')}} : {{$chapter->user->pseudo}}</h5>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6 sm-grid-content mb-30">
                                    ...
                                    <div class="post-content media-body">
                                        <a href="{{ route('manga.liste', ['slug' => $lier->slug])}}">
                                            <h6 class="post-title text-dark mb-10 text-limit-2-row">{{$lier->title}}</h6>
                        ...
                        <div class="banner-img wow fadeIn mb-45 animated d-lg-block d-none animated">
                            ...
                            <div class="banner-text">
                                <span>Zone Publicitaire</span>
                                <h4>Save 17% on <br>Office Dress</h4>
                                <a href="#">Visiter Maintenant <i class="fi-rs-arrow-right"></i></a>
                            </div>
                        </div>
                        <!--Widget Tags-->
                        <div class="sidebar-widget widget_tags mb-50">
                            ...
                            <div class="tagcloud">
                                ...
                                @endphp
                                <a class="tag-cloud-link" href="{{ route('manga.liste', ['slug' => $manga->slug]) }}">{{$manga->title}}</a>
                                @empty
