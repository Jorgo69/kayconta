                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-md-6">
                                        Ajout de nouvelle Chapitre
                                    </div>
                                    <div class="col-md-6">
                                        <a href="{{ route('author.dashboard')}}" class="btn btn-success float-end"> Tous les Chapitre</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <form wire:submit.prevent="ChaptersAdd">
                                    <div class="mb-3 mt-3">
                                        ...
                                        <select class="form-control" name="manga_id" id="mangas" wire:model="manga_id" @disabled(true)>
