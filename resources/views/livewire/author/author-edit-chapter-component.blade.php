                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <a href="{{ route('author.dashboard')}}" class="btn btn-success float-end"> Tous les Chapitres</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <form wire:submit.prevent="ChaptersEdit">
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        @if ($new_chapter_cover)
                                            <img src="{{$new_chapter_cover->temporaryUrl()}}" alt="20" width='50'>
                                        @else
                                            <img src="{{asset('kayconta-app/public/assets/imgs/chapters/covers')}}/{{$chapter_cover}}" width="50"/>
                                        @endif
