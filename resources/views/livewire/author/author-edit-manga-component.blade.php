        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span> Modification de Manga
                </div>
            </div>
        </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <a href="{{ route('author.dashboard')}}" class="btn btn-success float-end"> Tous les Mangas</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <form wire:submit.prevent="MangasEdit">
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        @else
                                        <img src="{{asset('kayconta-app/public/assets/imgs/mangas')}}/{{$cover_image}}" width="30" alt="">
                                        @endif
